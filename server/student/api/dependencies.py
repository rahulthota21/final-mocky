...
# Update: Import the correct Groq-based Whisper service
from core.groq_whisper_service import GroqWhisperService
...
def get_whisper_service():
    # Update: Return the GroqWhisperService instance
